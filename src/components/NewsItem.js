                ...
                <div className="card" style={{width: "18rem"}}>
                    <img className="card-img-top" src={imageUrl==null?noNewsImage:imageUrl} alt=""/>
                        <div className="card-body">
                            ...
                            <p className="card-text"><small className="text-muted">By {author==null? "Unknown" : author} on {new Date(date).toLocaleString("en-US", {timeZone: "Asia/Kolkata"})} (IST) </small></p>
